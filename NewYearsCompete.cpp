...
int main()
{
	...
	cout << "Общее число попыток: " << total << "/100" << ": " << 100 - total << " = " << etalon << "\n\n";
	
	cout << playerOneName << ":\n";
	//cout << "Сделано бросков: " << shoot1 << "\n";
	cout << "Собрано снежных комьев: " << totalOne << "\n\n";
	
	cout << playerTwoName << ":\n";
	//cout << "Сделано бросков: " << shoot2 << "\n";
	cout << "Собрано снежных комьев: " << totalTwo << "\n\n";
	
	cout << "Итог игры:\n\n";
	cout << playerOneName << " сможет слепить " << totalOne / 3 << " снеговиков!" << "\n";
	cout << playerTwoName << " сможет слепить " << totalTwo / 3 << " снеговиков!" << "\n"; 
